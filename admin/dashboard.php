...
<section class="dashboard">
   ...
   <div class="box">
      <?php
         $select_users = $conn->prepare("SELECT * FROM `orders` where payment_status= 'pending'");
         $select_users->execute();
         $numbers_of_users = $select_users->rowCount();
      ?>
      <h3><?= $numbers_of_users; ?></h3>
      <p>Product Approval</p>
      <a href="product_approve.php" class="btn">see orders</a>
   </div>
   ...
   <div class="box">
      <?php
         $select_riders = $conn->prepare("SELECT * FROM `riders_user`");
         $select_riders->execute();
         $numbers_of_riders = $select_riders->rowCount();
      ?>
      <h3><?= $numbers_of_riders; ?></h3>
      <p>Riders Users</p>
      <a href="riders_user_accounts.php" class="btn">See Riders User</a>
   </div>
